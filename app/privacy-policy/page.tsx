        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "40px", lineHeight: "1.8", color: "rgba(245,240,232,0.65)", fontSize: "14.5px", textAlign: "justify" }}>
          ...
          <section>
            ...
            <p style={{ marginBottom: "12px" }}>
              Celestial Harmony Academy of Music acts as the sole custodian of data collected via this digital platform. We process personal information strictly to fulfill scheduling requests and administrative enrollment cycles.
            </p>
            <p>The specific parameters collected through our active admission portals, contact modules, and interaction wrappers include:</p>
            <ul style={{ paddingLeft: "20px", marginTop: "8px", display: "flex", flexDirection: "column", gap: "6px" }}>
              <li><strong style={{ color: "#fff" }}>Personal Identifiers:</strong> Full names of student candidates, alongside primary names of parents or legal guardians for applicants under legal age limits.</li>
              <li><strong style={{ color: "#fff" }}>Contact Telemetry:</strong> Active telephone sequences, mobile phone channels, and linked WhatsApp connection profiles.</li>
              <li><strong style={{ color: "#fff" }}>Academic Metrics:</strong> Primary musical instrument selection (e.g., Guitar, Piano, Violin, Keyboard, Drums) and relative background tracking proficiency.</li>
            </ul>
          </section>

          <section>
            <h2 style={{ color: "#ffffff", fontSize: "19px", fontFamily: "'DM Serif Display', serif", fontWeight: 400, marginBottom: "14px", letterSpacing: "0.01em" }}>2. Methods of Processing and Usage Architecture</h2>
            <p>Your institutional telemetry data streams are systematically processed for the explicit production milestones detailed below:</p>
            <ul style={{ paddingLeft: "20px", marginTop: "8px", display: "flex", flexDirection: "column", gap: "6px" }}>
              <li>To initialize direct communication vectors to coordinate trial lessons, diagnostic student scheduling, and local campus evaluations at KPHB Hyderabad.</li>
              <li>To register and track student progress metrics aligned directly with the international public evaluation parameters of the Trinity College London Grade Examination structure.</li>
              <li>To dispatch formal institutional updates, emergency campus schedule modifications, and customized educational notifications.</li>
            </ul>
          </section>

          <section>
            <h2 style={{ color: "#ffffff", fontSize: "19px", fontFamily: "'DM Serif Display', serif", fontWeight: 400, marginBottom: "14px", letterSpacing: "0.01em" }}>3. Data Protection and Zero-Sharing Mandate</h2>
            <p>We enforce a strict data security model across our operational pipeline. We do not sell, rent, lease, distribute, trade, or expose electronic student records or telemetry streams to third-party data aggregators, commercial brokers, or algorithmic advertisement clearing houses under any circumstances.</p>
          </section>
